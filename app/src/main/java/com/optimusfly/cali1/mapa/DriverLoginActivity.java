    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    Intent intent = new Intent(DriverLoginActivity.this, DriverMapaActivity.class);
                ...
                auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(!task.isSuccessful()){
                            Toast.makeText(DriverLoginActivity.this,"registro Error",Toast.LENGTH_LONG).show();

                        }else{
                            String user_id = auth.getCurrentUser().getUid();
                            DatabaseReference currentUserDb = FirebaseDatabase.getInstance().getReference().child("Users").child("Riders").child(user_id);
            ...
            public void onClick(View view) {
                ...
                auth.signInWithEmailAndPassword(email,password).addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(!task.isSuccessful()){
                            Toast.makeText(DriverLoginActivity.this,"Error al entrar",Toast.LENGTH_LONG).show();
